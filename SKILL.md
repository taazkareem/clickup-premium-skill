...
To reduce context noise and improve AI accuracy, you can limit the tools available to your agent using the `X-Enabled-Tools` header in your `mcporter` config. This is highly recommended for complex workspaces.

### Recommended Tool Presets

Users can apply these headers to their ClickUp server configuration to optimize performance for specific use cases:

| Persona | Purpose | mcporter Header |
| :--- | :--- | :--- |
